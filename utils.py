...
writer = open('/kaggle/working/test_mulit_merge_result_1008.json','a+',encoding='utf-8')
train_data = json.load(open('./data/multi_test_1008_merge.json','r',encoding='utf-8'))
